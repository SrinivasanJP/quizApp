  ...
  return (
    <div className="flex justify-between w-full m-2">
        ...
        <div className='flex gap-10 text-4xl mr-5 '>
            ...
            -600 rounded-2xl text-white px-6 py-2 border-solid border-2 border-blue-200 hover:bg-gray-850 font-serif text-sm md:text-xl' onClick={()=>setFragment("createQuiz")}>create quizz</a>
            <a src="" className='bg-black
